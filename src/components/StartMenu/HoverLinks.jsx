    ...
    <section className="bg-blue-500/10 w-full p-4 md:p-8">
      <div className="mx-auto max-w-5xl">
        <Link
          ...
          subheading="Find your favorite Pokémon"
          imgSrc="/images/pokemon-bg.jpg"
          href="/base"
        />
        <Link
          heading="Start Journey"
          subheading="Begin your adventure here with us"
          imgSrc="/images/start-journey-wp.jpg"
          href="/startgame"
        />
        <Link
          heading="About"
          subheading="Learn more about us"
          imgSrc="/images/wp-about-pikachu.jpg"
          href="/about"
        />
        <Link
          heading="Trainer's Profile"
          subheading="Manage your profile"
          imgSrc="/images/wp-trainer-pokemon.jpg"
          href="/profile"
        />
      </div>
    </section>
  ...
  return (
    ...
    >
        ...
        >
          ...
          {heading.split("").map((l, i) => (
            <motion.span
              ...
              key={i}
            >
              {/* If There is space, we change it for "\u00A0*/}
              {l === " " ? "\u00A0" : l}
            </motion.span>
          ))}
        </motion.span>
      ...
      <motion.img
        ...
        transition={{ type: "spring" }}
        src={imgSrc}
        className="absolute z-2 h-24 w-32 rounded-lg object-cover md:h-48 md:w-64"
