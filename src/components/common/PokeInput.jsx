...
export default function PokeInput({ searchQuery = "", onSearch = () => {} }) {
  ...
  // Обновление локального состояния когда меняется searchQuery
  useEffect(() => {
  ...
  return (
    <div className="my-2 md:w-[25rem] relative">
      ...
      />
      <div
        className={`flex items-center border border-gray-300 rounded-sm bg-white transition-all duration-300 ${
          isFocused
